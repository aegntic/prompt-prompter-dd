...
[![CI/CD Pipeline](https://github.com/YOUR_USERNAME/prompt-prompter/actions/workflows/ci.yml/badge.svg)](https://github.com/YOUR_USERNAME/prompt-prompter/actions)
...
5. **Triggers** alerts and incidents when thresholds breach
...
- 📈 **Dashboard** – Pre-built health dashboard for instant visibility
- 🎯 **SLOs** – 99% latency < 2s target with error budget tracking
- 🎨 **Gradio UI** – Beautiful, interactive interface for testing

## 🏗️ Architecture

```
┌─────────────────┐      ┌──────────────────┐      ┌─────────────────┐
│   Gradio UI     │──────│  FastAPI Server  │──────│  Vertex AI      │
...
```bash
git clone https://github.com/YOUR_USERNAME/prompt-prompter.git
cd prompt-prompter
...
| 0:15-0:45 | Submit bad prompt → Show low score (0.6) |
| 0:45-1:15 | Show Datadog dashboard → Metrics flowing |
...
```
prompt-prompter/
├── app.py              # FastAPI + Gradio main application
...
Built with ❤️ for the Datadog Hackathon | Powered by Vertex AI Gemini ✨
