...
initialize(api_key=DD_API_KEY, app_key=DD_APP_KEY, api_host="https://api.ap2.datadoghq.com")
...
PROMPTS = [
    ...
    {
        "type": "devops",
        "text": "Analyze these Kubernetes pod logs and explain why the container crashed: [Log Snippet]",
        "complexity": "high",
    },
    {
        "type": "devops",
        "text": "Generate a Terraform module for a high-availability AWS ECS cluster.",
        "complexity": "high",
    },
    {
        "type": "devops",
        "text": "Write a bash script to rotate SSL certificates automatically.",
        "complexity": "medium",
    },
    # Security
    {
        "type": "security",
        "text": "Scan this Python code for SQL injection vulnerabilities.",
        "complexity": "high",
    },
    {
        "type": "security",
        "text": "Draft an incident response email for a potential data breach.",
        "complexity": "medium",
    },
    {
        "type": "security",
        "text": "Explain the difference between SOC2 Type 1 and Type 2 compliance.",
        "complexity": "low",
    },
    # Data Engineering
    {
        "type": "data",
        "text": "Write a SQL query to optimize this slow-running join on 10M rows.",
        "complexity": "high",
    },
    {
        "type": "data",
        "text": "Create a schema for a customer 360 view in BigQuery.",
        "complexity": "medium",
    },
    {
        "type": "data",
        "text": "Regex to extract phone numbers from this unstructured text.",
        "complexity": "low",
    },
    # Legal / Finance
    {
        "type": "legal",
        "text": "Summarize this 50-page MSA and highlight indemnity clauses.",
        "complexity": "high",
    },
    {
        "type": "finance",
        "text": "Forecast Q4 revenue based on these historical CSV data points.",
        "complexity": "high",
    },
]
    ...
    while current_time < end_time:
            ...
            [
                {
                    ...
                    "points": [(current_time, accuracy)],
                    "tags": tags,
                    "type": "gauge",
                },
                {
                    "metric": "prompt.tokens",
                    "points": [(current_time, tokens)],
                    "tags": token_tags,
                    "type": "gauge",
                },
                {
                    "metric": "prompt.latency_ms",
                    "points": [(current_time, latency)],
                    "tags": tags,
                    "type": "gauge",
                },
                {
                    "metric": "prompt.cost_usd",
                    "points": [(current_time, cost)],
                    "tags": tags,
                    "type": "gauge",
                },
                {
                    "metric": "prompt.requests",
                    "points": [(current_time, 1)],
                    "tags": tags,
                    "type": "count",
                },
                {
                    "metric": "prompt.hallucination",
                    "points": [(current_time, hallucination)],
                    "tags": tags,
                    "type": "gauge",
                },
                {
                    "metric": "prompt.semantic_similarity",
                    "points": [(current_time, semantic_similarity)],
                    "tags": tags,
                    "type": "gauge",
                },
            ]
        ...
        if len(metrics_batch) >= 100:
            try:
                ...
                print(
                    f"Sent {len(metrics_batch)} points... (Current date: {datetime.fromtimestamp(current_time)})"
                )
                metrics_batch = []
